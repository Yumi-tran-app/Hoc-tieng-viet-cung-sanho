...
══════════════════════════════════════════════════════════════ */
const BLEND_STAGES = [
  { id:1, name:"Giai đoạn 1 · Âm đơn & dấu thanh", badge:"🌱", color:"#2D9E68", sub:"17 phụ âm đơn + nguyên âm cơ bản",
    lessons:[
      ...
      {co:"h",vo:"e",r:"he", bd:["hờ","e","he"], ops:["he","ha","me"], em:"🙂",mn:"he (he he cười)"},
      {co:"k",vo:"e",r:"kẻ", bd:["cờ","e","ke","hỏi","kẻ"], ops:["kẻ","ke","kẹ"], em:"🖊️",mn:"kẻ (kẻ vẽ)"},
      {co:"l",vo:"á",r:"lá", bd:["lờ","a","la","sắc","lá"], ops:["lá","la","là"], em:"🍃",mn:"lá (lá cây)"},
      {co:"m",vo:"e",r:"me", bd:["mờ","e","me"], ops:["me","mẹ","ma"], em:"🌿",mn:"me (me me)"},
      {co:"n",vo:"a",r:"na", bd:["nờ","a","na"], ops:["na","nà","ma"], em:"🍈",mn:"na (quả na)"},
      {co:"p",vo:"o",r:"po", bd:["pờ","o","po"], ops:["po","bo","pô"], em:"🔤",mn:"po (âm pờ o)"},
      {co:"r",vo:"ổ",r:"rổ", bd:["rờ","ô","rô","hỏi","rổ"], ops:["rổ","rô","rồ"], em:"🧺",mn:"rổ (cái rổ)"},
      {co:"s",vo:"ao",r:"sao", bd:["sờ","ao","sao"], ops:["sao","sào","xao"], em:"⭐",mn:"sao (ngôi sao)"},
      {co:"t",vo:"a",r:"ta", bd:["tờ","a","ta"], ops:["ta","tà","đa"], em:"👤",mn:"ta (chúng ta)"},
      {co:"v",vo:"i",r:"vi", bd:["vờ","i","vi"], ops:["vi","ví","bi"], em:"📝",mn:"vi (viết)"},
      {co:"x",vo:"e",r:"xe", bd:["xờ","e","xe"], ops:["xe","xé","se"], em:"🚗",mn:"xe (xe máy)"},
      {co:"q",vo:"ua",r:"qua", bd:["quờ","a","qua"], ops:["qua","quà","cua"], em:"🚶",mn:"qua (đi qua)"},
    ]},
  { id:2, name:"Giai đoạn 2 · Phụ âm ghép & chính tả", badge:"🌿", color:"#2D87B8", sub:"ch, gh, gi, kh, nh, ng, ngh, ph, qu, th, tr", ua:1,
    lessons:[
      ...
      {co:"gh",vo:"ê",r:"ghế", bd:["ghờ","ê","ghê","sắc","ghế"], ops:["ghế","ghe","ghê"], em:"🪑",mn:"ghế (cái ghế)"},
      ...
      {co:"ngh",vo:"ệ",r:"nghệ", bd:["nghờ","ê","nghê","nặng","nghệ"], ops:["nghệ","nghê","nghè"], em:"🌿",mn:"nghệ (củ nghệ)"},
...
const SENTENCE_STAGES = [
  { id:1, name:"Giai đoạn 1 · Câu 2-3 từ", badge:"🌱", color:"#2D9E68", sub:"Bà bế bé",
    sentences:[
      ...
      { words:["Bé","yêu","mẹ"], emoji:"❤️", mn:"Bé yêu mẹ." },
      { words:["Mẹ","bế","bé"], emoji:"🤱", mn:"Mẹ bế bé." },
      { words:["Bố","đi","làm"], emoji:"💼", mn:"Bố đi làm." },
      { words:["Bà","đọc","thơ"], emoji:"📖", mn:"Bà đọc thơ." },
      { words:["Ông","tưới","cây"], emoji:"🌱", mn:"Ông tưới cây." },
      { words:["Chị","quét","nhà"], emoji:"🧹", mn:"Chị quét nhà." },
      { words:["Anh","đá","bóng"], emoji:"⚽", mn:"Anh đá bóng." },
      { words:["Bé","ăn","cơm"], emoji:"🍚", mn:"Bé ăn cơm." },
      { words:["Bé","uống","sữa"], emoji:"🥛", mn:"Bé uống sữa." },
      { words:["Bé","đi","ngủ"], emoji:"😴", mn:"Bé đi ngủ." },
      { words:["Bé","tô","màu"], emoji:"🎨", mn:"Bé tô màu." },
      { words:["Bé","rửa","tay"], emoji:"🧼", mn:"Bé rửa tay." },
      { words:["Bé","đánh","răng"], emoji:"🪥", mn:"Bé đánh răng." },
      { words:["Bé","tập","bơi"], emoji:"🏊", mn:"Bé tập bơi." },
      { words:["Bé","đi","học"], emoji:"🎒", mn:"Bé đi học." },
      { words:["Chó","giữ","nhà"], emoji:"🐕", mn:"Chó giữ nhà." },
      { words:["Mèo","bắt","chuột"], emoji:"🐱", mn:"Mèo bắt chuột." },
      { words:["Bò","ăn","cỏ"], emoji:"🐄", mn:"Bò ăn cỏ." },
      { words:["Gà","đẻ","trứng"], emoji:"🐔", mn:"Gà đẻ trứng." },
      { words:["Cá","bơi","lội"], emoji:"🐟", mn:"Cá bơi lội." },
      { words:["Khỉ","leo","cây"], emoji:"🐒", mn:"Khỉ leo cây." },
      { words:["Thỏ","chạy","nhanh"], emoji:"🐇", mn:"Thỏ chạy nhanh." },
      { words:["Chim","hót","vang"], emoji:"🐦", mn:"Chim hót vang." },
      { words:["Trời","mưa","to"], emoji:"🌧️", mn:"Trời mưa to." },
      { words:["Trăng","rất","sáng"], emoji:"🌙", mn:"Trăng rất sáng." },
      { words:["Gió","thổi","mát"], emoji:"🌬️", mn:"Gió thổi mát." },
      { words:["Hoa","nở","rộ"], emoji:"🌸", mn:"Hoa nở rộ." },
      { words:["Cây","xanh","tốt"], emoji:"🌳", mn:"Cây xanh tốt." },
      { words:["Xe","chạy","nhanh"], emoji:"🚗", mn:"Xe chạy nhanh." },
      { words:["Quả","bóng","lăn"], emoji:"🏀", mn:"Quả bóng lăn." },
    ]},
